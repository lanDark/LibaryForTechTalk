									...
									<div class="megamenu mega03">
										<ul class="item item03">
											<li class="title">Categories</li>
                                                                                        <c:forEach var="danhMuc" items="${category[0]}">
                                                                                            <c:forEach var="value" items="${category[1]}">
                                                                                                <c:if test="${danhMuc.url == value.key}">
                                                                                                   <li><a href="<c:url value="category/${danhMuc.url}"/>" >${danhMuc.tenDanhMuc}(${value.value}) </a></li>
                                                                                                </c:if>
                                                                                            </c:forEach>
                                                                                        </c:forEach>
